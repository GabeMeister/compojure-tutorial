...
(defn- parse-css-property
  "Given a css class, return just the css property itself
   without modifiers (e.g. remove `md:hover:` in front) and without spacing 
   (e.g. `-[20px]` or `-24` at the end)"
  [class]
...
(defn- css-reducer
  "Given a css map, add in the appropriate keys and 
   final value of the given css class"
  [css-map class]
